<?php $__env->startSection('title', \App\Helpers\TranslationHelper::translate('Control the expiration duration')); ?>
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <table class="table table-rounded align-middle table-striped border gy-5 gs-7 dataTable no-footer"
                ...
                <tr>
                    <th>#</th>
                    <th><?php echo e(\App\Helpers\TranslationHelper::translate('Lesson Expiration Time')); ?></th>
                    <th><?php echo e(\App\Helpers\TranslationHelper::translate('Package Expiration Time')); ?></th>
...
<?php $__env->startPush('admin_js'); ?>
    ...
    <script>
        ...
        var table1 = $('#kt_table_users').DataTable({
            ...
            processing: true,
            ajax: {
                url: '<?php echo e(route('admin.controlExpirationDuration.table')); ?>',
                data: function (d) {
                    d.id = $('#id').val();
                    d.name = $('#name').val();
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp_new\htdocs\sameh_stein\resources\views/admin/pages/controlExpirationDuration/index.blade.php ENDPATH**/ ?>