<?php $__env->startSection('title', \App\Helpers\TranslationHelper::translate('Messages')); ?>
...
<?php $__env->startPush('admin_js'); ?>
    ...
    order: [[0, "desc"]],
    ajax: {
        url: '<?php echo e(route('admin.message.table')); ?>',
        data: function (d) {
            d.name = $('#name').val();    // حقل البحث بالاسم
            d.email = $('#email').val();  // حقل البحث بالإيميل
            d.phone = $('#phone').val();  // حقل البحث بالهاتف
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp_new\htdocs\sameh_stein\resources\views/admin/pages/message/index.blade.php ENDPATH**/ ?>