            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="contact-card text-center shadow-sm p-4 rounded-4">
                        ...
                        <h6 class="fw-600 mb-2"><?php echo e(\App\Helpers\TranslationHelper::translate('Call us')); ?></h6>
                        <p class="mb-1">
                            <a href="tel:+12345678" class="fw-700 color-primary"><?php echo e($contact->phone); ?></a>
                        </p>
                ...
                <div class="col-md-4">
                    <div class="contact-card text-center shadow-sm p-4 rounded-4">
                        ...
                        <h6 class="fw-600 mb-2"><?php echo e(\App\Helpers\TranslationHelper::translate('whatsapp')); ?></h6>
                        <p>
                            <a href="tel:<?php echo e($contact->whatsapp); ?>"
                                class="fw-700 color-primary"><?php echo e($contact->whatsapp); ?></a>
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="contact-card text-center shadow-sm p-4 rounded-4">
                        ...
                        <h6 class="fw-600 mb-2"><?php echo e(\App\Helpers\TranslationHelper::translate('Our Location')); ?></h6>
                        <p class="text-muted"><?php echo e($contact->address); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    <div class="img-contact">
                        <img src="<?php echo e($contact->getFirstMediaUrl('contacts_meta_image')); ?>" alt="contact"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <input type="phone" name="phone" id="phone" class="form-control"
                                        placeholder="<?php echo e(\App\Helpers\TranslationHelper::translate('Phone')); ?>" required>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12 text-end">
                                    <button type="submit" class="btn btn-primary px-4">
                                        <?php echo e(\App\Helpers\TranslationHelper::translate('submit')); ?>
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp_new\htdocs\sameh_stein\resources\views/front/pages/message.blade.php ENDPATH**/ ?>