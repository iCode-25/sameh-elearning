        ...
        <div class="d-flex align-items-stretch justify-content-end flex-lg-grow-1"
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                   ...
                   <div class="tr-header-right-lang d-none d-md-block me-3 mt-4 ps-3">
                            <select class="tr-select-lang form-select text-white" style="background-color: #666060;" onchange="location.href=this.value">
                                <option value="<?php echo e(LaravelLocalization::getLocalizedURL('ar')); ?>" <?php if(app()->getLocale() == 'ar'): ?> selected <?php endif; ?>>AR</option>
                                <option value="<?php echo e(LaravelLocalization::getLocalizedURL('en')); ?>" <?php if(app()->getLocale() == 'en'): ?> selected <?php endif; ?>>EN</option>
                            </select>
                        </div>
                        ...
                        <div data-kt-search-element="content"
                                    ...
                                    <div class="scroll-y mh-200px mh-lg-350px">
                                        ...
                                        <a href="#"
                                           class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <img src="<?php echo e(asset('dashboard/assets/media/avatars/300-6.jpg')); ?>"
                                                     alt=""/>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                        ...
                                        <a href="#"
                                           class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-40px me-4">
                                                <img src="<?php echo e(asset('dashboard/assets/media/avatars/300-2.jpg')); ?>"
                                                     alt=""/>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                        ...
                                        <a href="#"
                                           class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-40px me-4">
                                                <img src="<?php echo e(asset('dashboard/assets/media/avatars/300-9.jpg')); ?>"
                                                     alt=""/>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                        ...
                                        <a href="#"
                                           class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-40px me-4">
                                                <img src="<?php echo e(asset('dashboard/assets/media/avatars/300-14.jpg')); ?>"
                                                     alt=""/>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                        ...
                                        <a href="#"
                                           class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-40px me-4">
                                                <img src="<?php echo e(asset('dashboard/assets/media/avatars/300-11.jpg')); ?>"
                                                     alt=""/>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                            ...
                                            <div class="symbol symbol-40px me-4">
															<span class="symbol-label bg-light">
																<img class="w-20px h-20px"
                                                                     src="<?php echo e(asset('dashboard/assets/media/svg/brand-logos/volicity-9.svg')); ?>"
                                                                     alt=""/>
															</span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#"
                                           class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
															<span class="symbol-label bg-light">
																<img class="w-20px h-20px"
                                                                     src="<?php echo e(asset('dashboard/assets/media/svg/brand-logos/tvit.svg')); ?>"
                                                                     alt=""/>
															</span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#"
                                           class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
															<span class="symbol-label bg-light">
																<img class="w-20px h-20px"
                                                                     src="<?php echo e(asset('dashboard/assets/media/svg/misc/infography.svg')); ?>"
                                                                     alt=""/>
															</span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#"
                                           class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
															<span class="symbol-label bg-light">
																<img class="w-20px h-20px"
                                                                     src="<?php echo e(asset('dashboard/assets/media/svg/brand-logos/leaf.svg')); ?>"
                                                                     alt=""/>
															</span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#"
                                           class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
															<span class="symbol-label bg-light">
																<img class="w-20px h-20px"
                                                                     src="<?php echo e(asset('dashboard/assets/media/svg/brand-logos/tower.svg')); ?>"
                                                                     alt=""/>
															</span>
                                            </div>
                                            <!--end::Symbol-->
                            ...
                            <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                                ...
                                <div class="d-flex justify-content-end">
                                    <button type="reset"
                                            class="btn btn-sm btn-primary fw-bold btn-active-light-primary me-2"
                ...
                <div class="app-navbar-item ms-1 ms-md-4">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px"
                        ...
                        <div class="d-flex flex-column bgi-no-repeat rounded-top"
                             style="background-image:url('<?php echo e(asset('dashboard/assets/media/misc/menu-header-bg.jpg')); ?>')">
                            <!--begin::Title-->
                            ...
                            <div class="tab-pane fade" id="kt_topbar_notifications_1" role="tabpanel">
                                ...
                                <div class="py-3 text-center border-top">
                                    <a href="pages/user-profile/activity.html"
                                       class="btn btn-color-gray-600 btn-active-color-primary"><?php echo e(\App\Helpers\TranslationHelper::translate('View More')); ?>
                                ...
                                <div class="d-flex flex-column px-9">
                                    ...
                                    <div class="text-center px-4">
                                        <img class="mw-100 mh-200px" alt="image"
                                             src="<?php echo e(asset('dashboard/assets/media/illustrations/sketchy-1/1.png')); ?>"/>
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                                <!--end::Wrapper-->
                                ...
                                <div class="scroll-y mh-325px my-5 px-8">
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                               class="text-gray-800 text-hover-primary fw-semibold"><?php echo e(\App\Helpers\TranslationHelper::translate('Server OS update')); ?>
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <!--end::Section-->
                                        <!--begin::Label-->
                                        <span class="badge badge-light fs-8"> <?php echo e(\App\Helpers\TranslationHelper::translate('Jun')); ?>30</span>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            <!--begin::Code-->
                                            <span class="w-70px badge badge-light-danger me-4">500<?php echo e(\App\Helpers\TranslationHelper::translate('ERR')); ?>

															</span>
                                            <!--end::Code-->
                                            <!--begin::Title-->
                                            <a href="#"
                                               class="text-gray-800 text-hover-primary fw-semibold">Refund<?php echo e(\App\Helpers\TranslationHelper::translate('Pro')); ?>
                                        ...
                                        <!--end::Section-->
                                        <!--begin::Label-->
                                        <span class="badge badge-light fs-8"><?php echo e(\App\Helpers\TranslationHelper::translate('Jul')); ?> 10</span>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            <!--begin::Code-->
                                            <span class="w-70px badge badge-light-danger me-4">500
															<?php echo e(\App\Helpers\TranslationHelper::translate('ERR')); ?></span>
                                            <!--end::Code-->
                                            <!--begin::Title-->
                                            <a href="#"
                                               class="text-gray-800 text-hover-primary fw-semibold"><?php echo e(\App\Helpers\TranslationHelper::translate('Withdrawal process ')); ?>
                                        ...
                                        <!--end::Section-->
                                        <!--begin::Label-->
                                        <span class="badge badge-light fs-8"><?php echo e(\App\Helpers\TranslationHelper::translate('Sep')); ?> 10</span>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                               class="text-gray-800 text-hover-primary fw-semibold">Mail<?php echo e(\App\Helpers\TranslationHelper::translate('Pro')); ?>

                                                <?php echo e(\App\Helpers\TranslationHelper::translate('tasks')); ?></a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                        <!--begin::Label-->
                                        <span class="badge badge-light fs-8"><?php echo e(\App\Helpers\TranslationHelper::translate('Dec')); ?> 10</span>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Item-->
                                </div>
                ...
                <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-35px"
                        ...
                        <img src=" <?php echo e(setting('image_logo_dashboard', 'en')); ?>" class="rounded-3" style="width: 100%;"  alt="user"/>
                    ...
                    <div
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <!--begin::Username-->
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5"><?php echo e(\App\Helpers\TranslationHelper::translate('Admin')); ?>

                                        <span
                                            class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2"><?php echo e(\App\Helpers\TranslationHelper::translate('Pro')); ?></span>
                                    </div>
                                    <a href="#"
                                       class="fw-semibold text-muted text-hover-primary fs-7"><?php echo e(auth('admin')->user()->email); ?></a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
                        ...
                        <div class="menu-item px-5">
                            <a class="menu-link px-5" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
                                <?php echo e(\App\Helpers\TranslationHelper::translate('Sign Out')); ?>
...
<?php /**PATH D:\xampp_new\htdocs\abdElHmidQuritem\resources\views/admin/layouts/includes/header.blade.php ENDPATH**/ ?>