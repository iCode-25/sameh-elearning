<?php $__env->startSection('title', \App\Helpers\TranslationHelper::translate('Categories')); ?>
...
<?php $component = App\View\Components\BreadCrumb::resolve(['breadcrumbs' => [
        ['text' => \App\Helpers\TranslationHelper::translate('Categories'), 'link' => route('admin.level.index')],
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <div class="card-toolbar w-100 mb-7">
                <div class="d-flex justify-content-between w-100 data-kt-Customer-table-toolbar">
                    <div class="left-part">
                        <?php if(auth()->guard('admin')->user()->can('level.create', 'admin')): ?>
                            <a href="<?php echo e(route('admin.level.create')); ?>" class="btn btn-primary text-gray-800">
                                <i class="ki-duotone ki-plus fs-2  text-gray-800"></i>
                                <?php echo e(\App\Helpers\TranslationHelper::translate('Create Academic Level')); ?>

                            </a>
                        <?php endif; ?>
                        <?php if(auth()->guard('admin')->user()->can('level.sort', 'admin')): ?>
                            <a href="<?php echo e(route('admin.level.reorder')); ?>" class="btn btn-primary text-gray-800"
...
<?php $__env->startPush('admin_js'); ?>
    ...
    <script>
        ...
        var table1 = $('#kt_table_users').DataTable({
            ...
            ajax: {
                url: '<?php echo e(route('admin.level.table')); ?>',
                data: function(d) {
                    d.id = $('#id').val();
                    d.name = $('#name').val();
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp_new\htdocs\sameh_stein\resources\views/admin/pages/level/index.blade.php ENDPATH**/ ?>