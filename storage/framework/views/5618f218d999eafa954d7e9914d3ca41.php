<?php $__env->startSection('title', \App\Helpers\TranslationHelper::translate('Purchase Transactions')); ?>
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <table class="table table-rounded align-middle table-striped border gy-5 gs-7 dataTable no-footer"
                ...
                <thead>
                    <tr>
                        <th>#</th>
                        <th><?php echo e(\App\Helpers\TranslationHelper::translate('user_name')); ?></th>
                        <th><?php echo e(\App\Helpers\TranslationHelper::translate('coupon')); ?></th>
...
<?php $__env->startPush('admin_js'); ?>
    ...
    <script>
        ...
        var table1 = $('#kt_table_users').DataTable({
            ...
            ajax: {
                url: '<?php echo e(route('admin.voucherspage.table')); ?>',
                data: function(d) {
                    d.id = $('#id').val();
                }
            },
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp_new\htdocs\sameh_stein\resources\views/admin/pages/voucherspage/index.blade.php ENDPATH**/ ?>