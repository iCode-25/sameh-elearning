                            ...
                            <div class="course-sidebar">
                                <div class="pricing-block mb-24">
                                    ...
                                    <div class="d-flex justify-content-between mb-16">
                                        ...
                                        <p class="light-gray">
                                            <?php echo e($lesson->level->getTranslation('name', app()->getLocale())); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Qurtum\resources\views/front/pages/courses/details.blade.php ENDPATH**/ ?>