...
<?php if(auth()->guard('admin')->user()->can('roles.edit', 'admin')): ?>




<a href="<?php echo e(route('admin.role.edit',['role'=>$role->id])); ?>"
...
<?php if(auth()->guard('admin')->user()->can('roles.delete', 'admin')): ?>

<button type="button" data-url="<?php echo e(route('admin.role.destroy',['role'=>$role->id])); ?>"
...
<?php /**PATH D:\xampp_new\htdocs\sameh_stein\resources\views/admin/pages/role/buttons.blade.php ENDPATH**/ ?>