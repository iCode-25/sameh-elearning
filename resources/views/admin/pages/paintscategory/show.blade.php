...
@section('title', \App\Helpers\TranslationHelper::translate('Paintscategory us Details'))
@section('crumb')
    <x-bread-crumb :breadcrumbs="[
        ['text'=>\App\Helpers\TranslationHelper::translate('Paintscategory us'),'link'=>route('admin.paintscategory.index')],
                        ...
                        <div class="card-body py-4 px-0" dir="{{Config::get('app.locale') == 'en' ? 'ltr' : 'rtl'}}">
                            ...
                            <div class="row px-0 mt-3">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-left">
                                    <h4 class="d-inline-block  py-3">{{\App\Helpers\TranslationHelper::translate('Paints category us Details')}}</h4>
                                </div>
                               @if (auth()->guard('admin')->user()->can('paintscategory.edit', 'admin'))
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6  text-right">
                                        <a class="btn btn-primary text-center" style="margin-left: 25px"
                                           href="{{route('admin.paintscategory.edit', $paintscategory->id)}}">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 m-auto text-left ">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-6  text-left details_item ">
                                                {{$paintscategory->getTranslation('name',$key)}}
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                            ...
                            <div class="col-12 m-auto text-left">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-9 col-md-8 col-sm-12 details_item">
                                        <a href="{{ $paintscategory->getFirstMediaUrl('paints_category') }}" target="_blank">
