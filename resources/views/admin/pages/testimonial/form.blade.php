...
@if ($method == 'PUT')
    @section('title', \App\Helpers\TranslationHelper::translate('Edit Testimonial'))
@else
    @section('title', \App\Helpers\TranslationHelper::translate('Add Testimonial'))
@endif

@section('crumb')
    <x-bread-crumb :breadcrumbs="[
        ['text' => \App\Helpers\TranslationHelper::translate('Testimonials'), 'link' => route('admin.testimonial.index')],
        ['text' => __('methods.' . getLastKeyRoute(request()->route()->getName()))],
    ]" :button="['text' => \App\Helpers\TranslationHelper::translate('Go to Testimonial'), 'link' => route('admin.testimonial.index')]">
    </x-bread-crumb>
@endsection
                                    ...
                                    <div class="row">
                                        ...
                                        @foreach (Config('language') as $key => $lang)
                                           ...
                                           @foreach (Config('language') as $key => $lang)
                                            <div class="col-6 mb-5">
                                                ...
                                                <!--begin::Input-->
                                                <input type="text" class="form-control form-control-solid"
                                                       value="{{ old('name_job.'.$key) ?? $testimonial->getTranslation('name_job',$key)}}"
                                        ...
                                        @endforeach
                                            ...
                                            <div class="col-6 mb-5">
                                                ...
                                                <textarea class="form-control form-control-solid" rows="4"
                                                          ...
                                                          name="description[{{ $key}}]">{{ old('description.'.$key) ?? $testimonial->getTranslation('description',$key)}}</textarea>
                                        ...
                                        @endforeach
                                            ...
                                            <div class="col-6 mb-5">
                                                ...
                                                <!--begin::Input-->
                                                <input type="text" class="form-control form-control-solid"
                                                       value="{{ old('meta_title.'.$key) ?? $testimonial->getTranslation('meta_title',$key)}}"
                                        ...
                                        <div class="col-6  mb-5">
                                            ...
                                            @if($testimonial->getFirstMediaUrl('testimonials') != null)
                                                <img src="{{ $testimonial->getFirstMediaUrl('testimonials') }}"
                                                     alt="testimonials" width="100px"
...
{{-- 
                                          <div class="col-6 mb-5">
                                            ...
                                            <input type="text" class="form-control form-control-solid"
                                                value="{{ old('name_job') ?? $testimonial->name_job }}"
...
{{-- 
                                            ...
                                            <label
                                                ...
                                                : <span class="text-danger">
                                                    {{ \App\Helpers\TranslationHelper::translate('Size') }} <span
                                                        dir="ltr">400 x 400</span></span></label>
                                            <input type="file" class="form-control form-control-solid" name="image"
                                                value="{{ old('image') ?? $testimonial->getFirstMediaUrl('testimonials') }}" />
                                            @error('image')
                                                <span class="text-danger" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            @enderror
                                            @if ($testimonial->getFirstMediaUrl('testimonials_image') != null)
                                                <img src="{{ $testimonial->getFirstMediaUrl('testimonials') }}" alt="testimonials"
                                        ...
                                        <div class="col-12  mb-5">
                                            ...
                                            <textarea class="form-control form-control-solid " name="description" rows="5" id="description1"
                                                      style="height: 300px; direction: rtl;">{{ old('description') ?? $testimonial->description }}</textarea>
                                            @error('description')
                                                <span class="text-danger" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
