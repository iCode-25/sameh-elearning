...
@section('title', \App\Helpers\TranslationHelper::translate('city'))

@section('crumb')
    <x-bread-crumb :breadcrumbs="[
    ['text'=> \App\Helpers\TranslationHelper::translate('city'),'link'=>route('admin.place.index')],
...
{{--                        @can('place_places.create')--}}

                            <a href="{{ route('admin.place.create') }}" class="btn btn-primary text-gray-800">
                                <i class="ki-duotone ki-plus fs-2  text-gray-800"></i>
                                {{\App\Helpers\TranslationHelper::translate('Create city')}}
                            </a>
{{--                        @endcan--}}
{{--                        @can('place_places.sort')--}}

                            <a href="{{ route('admin.place.reorder') }}" class="btn btn-primary text-gray-800"
