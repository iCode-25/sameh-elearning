...
@section('title', \App\Helpers\TranslationHelper::translate('EventsManagement Details'))
@section('crumb')
                        ...
                        <div class="card-body py-4 px-0" dir="{{Config::get('app.locale') == 'en' ? 'ltr' : 'rtl'}}">
                            ...
                            <div class="row px-0 mt-3">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-left">
                                    <h4 class="d-inline-block  py-3">{{\App\Helpers\TranslationHelper::translate('EventsManagement Details')}}</h4>
...
@if (auth()->guard('admin')->user()->can('eventsManagement.edit', 'admin'))
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6  text-right">
                                        <a class="btn btn-primary text-center" style="margin-left: 25px"
                                           href="{{route('admin.eventsManagement.edit', $eventsManagement->id)}}">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 m-auto text-left ">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-6  text-left details_item ">
                                                {!! $eventsManagement->getTranslation('name',$key) !!}
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                                ...
                                @foreach (Config('language') as $key => $lang)
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 m-auto text-left ">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-6  text-left details_item ">
                                                {!! $eventsManagement->getTranslation('description',$key) !!}
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                               ...
                               <div class="row px-0 mt-3">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 m-auto text-left ">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-6  text-left details_item ">
                                            <a href="{{ $eventsManagement->getFirstMediaUrl('events_management_image') }}" target="_blank">
                                                <img src="{{ $eventsManagement->getFirstMediaUrl('events_management_image') }}" class="w-100"
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-12 m-auto text-left">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-left details_item">
                @if ($eventsManagement->getFirstMediaUrl('pdf'))
                    <a href="{{ $eventsManagement->getFirstMediaUrl('pdf') }}" target="_blank" class="btn btn-primary">
...
<div class="row px-0 mt-3">
    ...
    <div class="row">
       @if($eventsManagement->getFirstMediaUrl('events_managementvideo'))
