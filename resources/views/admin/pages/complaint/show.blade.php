...
@section('title', \App\Helpers\TranslationHelper::translate('Points setting us Details'))
@section('crumb')
    <x-bread-crumb :breadcrumbs="[
        ['text'=>\App\Helpers\TranslationHelper::translate('Points setting us'),'link'=>route('admin.complaint.index')],
                        ...
                        <div class="card-body py-4 px-0" dir="{{Config::get('app.locale') == 'en' ? 'ltr' : 'rtl'}}">
                            ...
                            <div class="row px-0 mt-3">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-left">
                                    <h4 class="d-inline-block  py-3">{{\App\Helpers\TranslationHelper::translate('Points setting us Details')}}</h4>

                                </div>
                                   {{-- @if (auth()->guard('admin')->user()->can('complaint.edit', 'admin'))
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6  text-right">
                                        <a class="btn btn-primary text-center" style="margin-left: 25px"
                                           href="{{route('admin.complaint.edit', $complaint->id)}}">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-12 m-auto text-left">
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-3 col-6 text-left details_item bold">
                {{ \App\Helpers\TranslationHelper::translate('invite_friend') }}
            </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-3 col-6 text-left details_item bold">
                {{ \App\Helpers\TranslationHelper::translate('product_code') }}
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-left details_item">
                {{ $complaint->email }}
            </div>
                                ...
                                @foreach (Config('language') as $key => $lang)
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 m-auto text-left ">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-6  text-left details_item ">
                                                {{$complaint->getTranslation('title',$key)}}
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
