...
@section('title', \App\Helpers\TranslationHelper::translate('Branche Details'))
@section('crumb')
...
@section('content')
                            ...
                            <div class="row px-0 mt-3">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-left">
                                    <h4 class="d-inline-block  py-3">
                                        {{ \App\Helpers\TranslationHelper::translate('Branche Details') }}</h4>
                                ...
                                @if (auth()->guard('admin')->user()->can('branche.edit', 'admin'))
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6  text-right">
                                        <a class="btn btn-primary text-center" style="margin-left: 25px"
                                            href="{{ route('admin.branche.edit', $branche->id) }}">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 m-auto text-left ">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-6  text-left details_item ">
                                                {{ $branche->getTranslation('name', $key) }}
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                                ...
                                @foreach (Config('language') as $key => $lang)
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 m-auto text-left ">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-6  text-left details_item ">
                                                {!! $branche->getTranslation('address', $key) !!}
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                            ...
                            <div class="row px-0 mt-3">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 m-auto text-left ">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-6  text-left details_item ">
                                            <a href="{{ $branche->getFirstMediaUrl('branches') }}" target="_blank">
                                                <img src="{{ $branche->getFirstMediaUrl('branches') }}" class="w-100"
                                                    alt="test"
    ...
    @foreach (Config('language') as $key => $lang)
        <div class="col-lg-12 col-md-12 col-sm-12 col-12 m-auto text-left ">
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-3 col-6 text-left details_item bold">
                    {{\App\Helpers\TranslationHelper::translate('City in')}} {{__('methods.' . $lang)}}:
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-left details_item">
                    {{$branche->city ? $branche->city->getTranslation('name', $key) : __('City not found')}}
                </div>
            </div>
        </div>
    @endforeach
                            ...
                            <div class="row px-0 mt-3">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 m-auto text-left">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-6 text-left details_item bold">
                                            {{ \App\Helpers\TranslationHelper::translate('Google Map Location') }}:
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-left details_item">
                                            <!-- عرض رابط Google Map بعد إزالة البيانات غير المرغوب فيها -->
                                            @php
                                                $googleMapData = json_decode($branche->google_map, true);
                                                $location = $googleMapData['ar'] ?? ''; // أو اختر اللغة التي تحتاجها
                                            @endphp
