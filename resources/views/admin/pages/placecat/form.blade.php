...
@if ($method == 'PUT')
    @section('title', \App\Helpers\TranslationHelper::translate('Edit Countries'))
@else
    @section('title', \App\Helpers\TranslationHelper::translate('Add Countries'))
@endif
...
@section('crumb')
    ...
    ]" :button="['text' => \App\Helpers\TranslationHelper::translate('Go to Countries'), 'link' => route('admin.placecat.index')]">
    </x-bread-crumb>
@endsection
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <form action="{{ $action }}" method="POST" enctype="multipart/form-data">
                                ...
                                @if($method == 'PUT')
                                    @method('PUT')
                                    <input type="hidden" name="id" value="{{$placecat->id}}">
                                    ...
                                    <div class="row">
                                        ...
                                        @foreach (Config('language') as $key => $lang)
                                            <div class="col-6 mb-5">
                                                ...
                                                <input type="text" class="form-control form-control-solid"
                                                       value="{{ old('title.'.$key) ?? $placecat->getTranslation('title',$key)}}"
                                      ...
                                      {{-- @foreach (Config('language') as $key => $lang)
                                            ...
                                            <textarea class="form-control form-control-solid full-editor" name="description[{{ $key}}]" rows="5" id="description{{$key}}"
                                                      style="height: 300px; direction: rtl;">{{ old('description.'.$key) ?? $placecat->getTranslation('description',$key)}}</textarea>
                                          ...
                                          {{-- @foreach (Config('language') as $key => $lang)
                                            <div class="col-6  mb-5">
                                                ...
                                                <input type="text" class="form-control form-control-solid" name="meta_title[{{ $key}}]"
                                                       value="{{ old('meta_title.'.$key) ?? $placecat->getTranslation('meta_title',$key)}}" />
                                        ...
                                        @endforeach
                                          ...
                                          @foreach (Config('language') as $key => $lang)
                                            <div class="col-6 mb-5">
                                                ...
                                                <!--begin::Input-->
                                                <input type="text" class="form-control form-control-solid"
                                                       value="{{ old('alt_text.'.$key) ?? $placecat->getTranslation('alt_text',$key)}}"
                                        ...
                                        @endforeach
                                          ...
                                          @foreach (Config('language') as $key => $lang)
                                            <div class="col-6 mb-5">
                                                ...
                                                <!--begin::Input-->
                                                <input type="text" class="form-control form-control-solid"
                                                       value="{{ old('meta_tags.'.$key) ?? $placecat->getTranslation('meta_tags',$key)}}"
                                        ...
                                        @foreach (Config('language') as $key => $lang)
                                            <div class="col-6 mb-5">
                                                ...
                                                <textarea class="form-control form-control-solid" rows="5"
                                                          ...
                                                          name="meta_description[{{ $key}}]">{{ old('meta_description.'.$key) ?? $placecat->getTranslation('meta_description',$key)}}</textarea>
                                        ...
                                        <div class="col-6  mb-5">
                                            ...
                                            @enderror
                                            @if($placecat->getFirstMediaUrl('placecats_meta_image') != null)
                                                <img src="{{ $placecat->getFirstMediaUrl('placecats_meta_image') }}"
                                                     alt="placecats" width="100px"
