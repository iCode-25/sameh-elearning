...
@section('title', \App\Helpers\TranslationHelper::translate('Documents'))
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card-toolbar w-100 mb-7">
                ...
                <div class="d-flex justify-content-between w-100 data-kt-Customer-table-toolbar">
                    <div class="left-part">
                        ...
                        <a href="{{ route('admin.document.create') }}" class="btn btn-primary text-gray-800">
                            <i class="ki-duotone ki-plus fs-2  text-gray-800"></i>
                            {{\App\Helpers\TranslationHelper::translate('Create Document')}}
                        </a>
                        @endcan
                        @can('documents.sort')

                        <a href="{{ route('admin.document.reorder') }}" class="btn btn-primary text-gray-800"
            ...
            <table class="table table-rounded align-middle table-striped border gy-5 gs-7 dataTable no-footer"
                ...
                <tr>
                    ...
                    <th>{{\App\Helpers\TranslationHelper::translate('Is Required')}}?</th>
...
@push('admin_js')
    ...
    <script>
        ...
        var table1 = $('#kt_table_users').DataTable({
            ...
            order: [[0, "desc"]],
            ajax: {
                url: '{{ route('admin.document.table') }}',
                data: function (d) {
                    d.id = $('#id').val();
                    d.name = $('#name').val();
            ...
            columns: [
                ...
                {data: 'is_required', name: 'is_required', defaultContent: '-'},
