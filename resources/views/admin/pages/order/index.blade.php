...
@section('title', \App\Helpers\TranslationHelper::translate('Bookings'))

@section('crumb')
    <x-bread-crumb :breadcrumbs="[
    ['text'=> \App\Helpers\TranslationHelper::translate('Bookings'),'link'=>route('admin.order.index')],
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card-toolbar w-100 mb-7">
                ...
                <div class="d-flex justify-content-between w-100 data-kt-Customer-table-toolbar">
                    <div class="left-part">
                        <!--begin::Add Provided Services-->

{{--                        <a href="{{ route('admin.service.create') }}" class="btn btn-primary text-gray-800">--}}
{{--                            <i class="ki-duotone ki-plus fs-2  text-gray-800"></i>--}}
{{--                            {{\App\Helpers\TranslationHelper::translate('Create Provided Services')}}--}}
{{--                        </a>--}}

{{--                        <a href="{{ route('admin.service.reorder') }}" class="btn btn-primary text-gray-800"--}}
    ...
    <script>
        ...
        var table1 = $('#kt_table_users').DataTable({
            ...
            columns: [
                ...
                {data: 'client_name', name: 'orders_count', defaultContent: '-'},
