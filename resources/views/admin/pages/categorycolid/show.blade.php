...
@section('title', \App\Helpers\TranslationHelper::translate('Category colid Details'))
@section('crumb')
                            ...
                            <div class="row px-0 mt-3">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-left">
                                    <h4 class="d-inline-block  py-3">
                                        {{ \App\Helpers\TranslationHelper::translate('Categorycolid Details') }}</h4>
                                ...
                                @if (auth()->guard('admin')->user()->can('categorycolid.edit', 'admin'))
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6  text-right">
                                        <a class="btn btn-primary text-center" style="margin-left: 25px"
                                            href="{{ route('admin.categorycolid.edit', $categorycolid->id) }}">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 m-auto text-left ">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-6  text-left details_item ">
                                                {{ $categorycolid->getTranslation('name', $key) }}
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
