...
@section('title', \App\Helpers\TranslationHelper::translate('Messages'))
...
{{--                        <a href="{{ route('admin.region.create') }}" class="btn btn-primary text-gray-800">--}}
{{--                            <i class="ki-duotone ki-plus fs-2  text-gray-800"></i>--}}
{{--                            {{\App\Helpers\TranslationHelper::translate('Create Region')}}--}}
{{--                        </a>--}}
