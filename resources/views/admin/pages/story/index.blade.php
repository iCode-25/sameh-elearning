...
@section('title', \App\Helpers\TranslationHelper::translate('Story'))
...
{{--                        @can('place_storys.create')--}}

                              @if (auth()->guard('admin')->user()->can('story.create', 'admin'))
                            <a href="{{ route('admin.story.create') }}" class="btn btn-primary text-gray-800">
                                <i class="ki-duotone ki-plus fs-2  text-gray-800"></i>
                                {{\App\Helpers\TranslationHelper::translate('Create Story')}}
                            </a>
                            @endif
{{--                        @endcan--}}
{{--                        @can('place_storys.sort')--}}
                           @if (auth()->guard('admin')->user()->can('story.sort', 'admin'))
                            <a href="{{ route('admin.story.reorder') }}" class="btn btn-primary text-gray-800"
