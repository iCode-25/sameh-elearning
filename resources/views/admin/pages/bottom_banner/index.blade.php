...
@section('title', \App\Helpers\TranslationHelper::translate('Bottom Banners'))

@section('crumb')
    <x-bread-crumb :breadcrumbs="[
        [
            'text' => \App\Helpers\TranslationHelper::translate('Bottom Banners'),
            'link' => route('admin.bottom_banner.index'),
        ],
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card-toolbar w-100 mb-7">
                ...
                <div class="d-flex justify-content-between w-100 data-kt-Customer-table-toolbar">
                    <div class="left-part">
                        <!--begin::Add Service-->
                        @can('bottom_banners.create')
                            <a href="{{ route('admin.bottom_banner.create') }}" class="btn btn-primary text-gray-800">
                                <i class="ki-duotone ki-plus fs-2  text-gray-800"></i>
                                {{ \App\Helpers\TranslationHelper::translate('Create Bottom Banner') }}
                            </a>
                        @endcan
...
@push('admin_js')
    ...
    <script>
        ...
        var table1 = $('#kt_table_users').DataTable({
            ...
            ajax: {
                url: '{{ route('admin.bottom_banner.table') }}',
                data: function(d) {
                    d.id = $('#id').val();
                    d.name = $('#name').val();
