...
@section('title', \App\Helpers\TranslationHelper::translate('Service SubCategory Details'))
@section('crumb')
                        ...
                        <div class="card-body py-4 px-0" dir="{{Config::get('app.locale') == 'en' ? 'ltr' : 'rtl'}}">
                            ...
                            <div class="row px-0 mt-3">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-left">
                                    <h4 class="d-inline-block  py-3">{{\App\Helpers\TranslationHelper::translate('Service SubCategory Details')}}</h4>

                                </div>
{{--                                @if( auth()->user()->id == 1 || auth()->user()->can('Region Edit'))--}}
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6  text-right">
                                        <a class="btn btn-primary text-center" style="margin-left: 25px"
                                           href="{{route('admin.service_sub_category.edit', $service_sub_category->id)}}">
...
{{--                                @endif--}}
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 m-auto text-left ">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-6  text-left details_item ">
                                                {{$service_sub_category->getTranslation('name',$key)}}
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-12 m-auto text-left ">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6  text-left details_item ">
                                        {{$service_sub_category->main->name}}
                                    </div>
                                </div>
                            </div>
                            <div class="row px-0 mt-3">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 m-auto text-left ">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-6  text-left details_item ">
                                            <a href="{{ $service_sub_category->getFirstMediaUrl('service_sub_categories') }}" target="_blank">
                                                <img src="{{ $service_sub_category->getFirstMediaUrl('service_sub_categories') }}" class="w-100"
                                                     alt="service_sub_category">
                                            </a>
                                        </div>
                                    </div>
                                </div>
