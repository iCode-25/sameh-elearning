...
@section('title', \App\Helpers\TranslationHelper::translate('Service SubCategories'))
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card-toolbar w-100 mb-7">
                ...
                <div class="d-flex justify-content-between w-100 data-kt-Customer-table-toolbar">
                    <div class="left-part">
                        <!--begin::Add Service-->
                        @can('service_subCategories.create')

                        <a href="{{ route('admin.service_sub_category.create') }}" class="btn btn-primary text-gray-800">
                            <i class="ki-duotone ki-plus fs-2  text-gray-800"></i>
                            {{\App\Helpers\TranslationHelper::translate('Create Service SubCategory')}}
                        </a>
                        @endcan
                        @can('service_subCategories.sort')

                        <a href="{{ route('admin.service_sub_category.reorder') }}" class="btn btn-primary text-gray-800"
            ...
            <table class="table table-rounded align-middle table-striped border gy-5 gs-7 dataTable no-footer"
                ...
                <tr>
                    ...
                    <th>{{\App\Helpers\TranslationHelper::translate('Main Category')}}</th>
...
@push('admin_js')
    ...
    <script>
        ...
        var table1 = $('#kt_table_users').DataTable({
            ...
            order: [[0, "desc"]],
            ajax: {
                url: '{{ route('admin.service_sub_category.table') }}',
                data: function (d) {
                    d.id = $('#id').val();
                    d.name = $('#name').val();
            ...
            columns: [
                ...
                {data: 'main_category', name: 'main_category', defaultContent: '-'},
