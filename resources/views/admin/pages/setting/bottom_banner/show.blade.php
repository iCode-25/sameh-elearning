...
@section('title', \App\Helpers\TranslationHelper::translate('Bottom Banner'))
@section('crumb')
                        ...
                        <div class="card-body py-4 px-0">
                            ...
                            <div class="row px-0 mt-3">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-left">
                                    <h4 class="d-inline-block  py-3">{{\App\Helpers\TranslationHelper::translate('Bottom Banner')}} </h4>

                                </div>
{{--                                @if( auth()->user()->id == 1 || auth()->user()->can('MainSetting Edit'))--}}
                                @can('bottom_banner.edit')

                                <div class="col-lg-6 col-md-6 col-sm-6 col-6  text-right">
                                        <a class="btn btn-primary text-center" style="margin-left: 25px"
                                           href="{{route('admin.setting.bottomBanner.edit')}}">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 m-auto text-left ">
                                    <div class="row">
                                        <div
                                            ...
                                            {{\App\Helpers\TranslationHelper::translate('Bottom Banner')}} :
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-6  text-left details_item "
                                             style="background: #ddd!important">
                                            <a href="{{ setting('bottom_banner','en') }}" target="_blank">
                                                <img src="{{ setting('bottom_banner','en') }}" style="width: 100%"
                                                     alt="logo">
                                            </a>
                                        </div>
                                    </div>
