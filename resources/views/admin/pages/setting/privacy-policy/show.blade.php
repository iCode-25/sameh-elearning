                        ...
                        <div class="card-body py-4 px-0">
                            ...
                            <div class="row px-0 mt-3">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-left">
                                    <h4 class="d-inline-block  py-3">{{\App\Helpers\TranslationHelper::translate('Privacy Policy Setting')}}</h4>
                                ...
                                @if (auth()->guard('admin')->user()->can('Find_best_places_index.edit', 'admin'))
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6  text-right">
                                        <a class="btn btn-primary text-center" style="margin-left: 25px"
                                           href="{{route('admin.setting.privacy_policy.edit')}}">
