...
@section('title', \App\Helpers\TranslationHelper::translate('Blogs'))
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <div class="card-toolbar w-100 mb-7">
                <div class="d-flex justify-content-between w-100 data-kt-Customer-table-toolbar">
                    <div class="left-part">
                        @if (auth()->guard('admin')->user()->can('blogs.create', 'admin'))
                            <a href="{{ route('admin.blog.create') }}" class="btn btn-primary text-gray-800">
                                <i class="ki-duotone ki-plus fs-2  text-gray-800"></i>
                                {{ \App\Helpers\TranslationHelper::translate('Create Blog') }}
                            </a>
                        @endif

                        @if (auth()->guard('admin')->user()->can('blogs.sort', 'admin'))
                            <a href="{{ route('admin.blog.reorder') }}" class="btn btn-primary text-gray-800"
