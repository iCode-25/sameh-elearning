...
@section('title', \App\Helpers\TranslationHelper::translate('Products'))
...
{{--                        @can('place_products.create')--}}
 @if (auth()->guard('admin')->user()->can('product.create', 'admin'))
                            <a href="{{ route('admin.product.create') }}" class="btn btn-primary text-gray-800">
                                <i class="ki-duotone ki-plus fs-2  text-gray-800"></i>
                                {{\App\Helpers\TranslationHelper::translate('Create Product')}}
                            </a>
                            @endif
{{--                        @endcan--}}

                          {{-- @if (auth()->guard('admin')->user()->can('product.sort', 'admin'))
                            <a href="{{ route('admin.product.reorder') }}" class="btn btn-primary text-gray-800"
