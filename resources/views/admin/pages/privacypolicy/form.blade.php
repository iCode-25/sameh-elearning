...
@if ($method == 'PUT')
    @section('title', \App\Helpers\TranslationHelper::translate('Edit Privacypolicy'))
@else
    @section('title', \App\Helpers\TranslationHelper::translate('Add Privacypolicy'))
@endif
...
@section('crumb')
    ...
    ]" :button="['text' => \App\Helpers\TranslationHelper::translate('Go to Privacypolicy'), 'link' => route('admin.privacypolicy.index')]">
    </x-bread-crumb>
@endsection
                                    ...
                                    <div class="row">
                                            ...
                                            {{-- <div class="col-6 mb-5">
                                                ...
                                                <textarea class="form-control form-control-solid" rows="4"
                                                          ...
                                                          name="description[{{ $key}}]">{{ old('description.'.$key) ?? $privacypolicy->getTranslation('description',$key)}}</textarea>
...
{{-- 
        ...
        <textarea class="form-control form-control-solid full-editor" name="description" rows="5" id="description"
                   style="height: 300px; direction: rtl;">{{ old('description') ?? $privacypolicy->description }}</textarea>
        @error('description')
            <span class="text-danger" role="alert">
                <strong>{{ $message }}</strong>
            </span>
