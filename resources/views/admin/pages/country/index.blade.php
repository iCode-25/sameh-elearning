...
@if (auth()->guard('admin')->user()->can('countries.create', 'admin'))
                        <a href="{{ route('admin.country.create') }}" class="btn btn-primary text-gray-800">
                            <i class="ki-duotone ki-plus fs-2  text-gray-800"></i>
                            {{\App\Helpers\TranslationHelper::translate('Create Country')}}
                        </a>
                        @endif
...
@push('admin_js')
    ...
    {data: 'name', name: 'name', defaultContent: '-', searchable: true}, // تأكد من تمكين البحث
