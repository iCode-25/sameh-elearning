...
@section('title', \App\Helpers\TranslationHelper::translate('Contacts'))
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <div class="card-toolbar w-100 mb-7">
                <div class="d-flex justify-content-between w-100 data-kt-Customer-table-toolbar">
                    <div class="left-part">
                        ...
                        {{-- @if (auth()->guard('admin')->user()->can('contact.create', 'admin'))
                            <a href="{{ route('admin.contact.create') }}" class="btn btn-primary text-gray-800">
                                <i class="ki-duotone ki-plus fs-2  text-gray-800"></i>
                                {{\App\Helpers\TranslationHelper::translate('Create Contact')}}
                            </a>
                            @endif --}}
            ...
            <table class="table table-rounded align-middle table-striped border gy-5 gs-7 dataTable no-footer"
                ...
                <thead>
                    <tr>
                        <th>#</th>
                        <th>{{ \App\Helpers\TranslationHelper::translate('facebook') }}</th>
                        <th>{{ \App\Helpers\TranslationHelper::translate('whatsapp') }}</th>
