...
@section('title', \App\Helpers\TranslationHelper::translate('Groups'))
            ...
            <div class="card-toolbar w-100 mb-7">
                ...
                <div class="d-flex justify-content-between w-100 data-kt-Customer-table-toolbar">
                    <div class="left-part">
                        ...
                        <a href="{{ route('admin.group.create') }}" class="btn btn-primary text-gray-800">
                            <i class="ki-duotone ki-plus fs-2  text-gray-800"></i>
                            {{\App\Helpers\TranslationHelper::translate('Create Group')}}
                        </a>
                        {{-- @endcan --}}

{{--                        <a href="{{ route('admin.group.reorder') }}" class="btn btn-primary text-gray-800"--}}
