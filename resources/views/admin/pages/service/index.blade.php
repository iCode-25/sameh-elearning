...
@section('title', \App\Helpers\TranslationHelper::translate('Service'))
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
                    ...
                    <div class="left-part">
                        ...
                        @can('services.create')
                            ...
                            <a href="{{ route('admin.service.create') }}" class="btn btn-primary text-gray-800">
                                ...
                                {{\App\Helpers\TranslationHelper::translate('Create Service')}}
                            </a>
                        @endcan
                        @can('services.sort')
            ...
            <table class="table table-rounded align-middle table-striped border gy-5 gs-7 dataTable no-footer"
                ...
                <tr>
                    ...
                    <th>{{\App\Helpers\TranslationHelper::translate('Pay With Cash')}}</th>
                    <th>{{\App\Helpers\TranslationHelper::translate('Pay With Card')}}</th>
    ...
    <script>
        ...
        var table1 = $('#kt_table_users').DataTable({
            ...
            columns: [
                ...
                {data: 'pay_cash', name: 'pay_cash', defaultContent: '-'},
                {data: 'pay_card', name: 'pay_card', defaultContent: '-'},
