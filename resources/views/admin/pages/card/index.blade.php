...
@section('title', \App\Helpers\TranslationHelper::translate('Card'))
            ...
            <div class="card-toolbar w-100 mb-7">
                ...
                <div class="d-flex justify-content-between w-100 data-kt-Customer-table-toolbar">
                    <div class="left-part">
                        ...
                        <a href="{{ route('admin.card.create') }}" class="btn btn-primary text-gray-800">
                            <i class="ki-duotone ki-plus fs-2  text-gray-800"></i>
                            {{ \App\Helpers\TranslationHelper::translate('Create Card') }}
                        </a>

                        {{-- @endcan --}}

                        {{--                        <a href="{{ route('admin.region.reorder') }}" class="btn btn-primary text-gray-800" --}}
            ...
            <table class="table table-rounded align-middle table-striped border gy-5 gs-7 dataTable no-footer"
                ...
                <thead>
                    <tr>
                        ...
                        <th>{{ \App\Helpers\TranslationHelper::translate('category_card') }}</th>
                        {{-- <th>{{\App\Helpers\TranslationHelper::translate('category')}}</th> --}}
                        <th>{{ \App\Helpers\TranslationHelper::translate('category colid') }}</th>
    ...
    <script>
        ...
        //           <'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
            ...
            columns: [{
                ...
                {
                    data: 'categorycolid_id',
                    name: 'categorycolid.name',
                    defaultContent: '-'
                },


                // {data: 'cardcard_video', name: 'cardcard_video', defaultContent: '-', orderable: false, searchable: false},
                {
                    data: 'created_at',
                    name: 'created_at',
                    defaultContent: '-'
