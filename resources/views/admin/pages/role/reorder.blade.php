                        ...
                        <div class="card-body py-4 px-0" >
                            ...
                            <div class="row px-0 mt-3">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-end">
                                    <a class="btn btn-primary btn-sm" href="{{route('admin.country.index')}}">{{\App\Helpers\TranslationHelper::translate('Go to Countries')}}</a>
...
@stop
@push('admin_js')
    @include('admin.layouts.reorder.js', ['max' => $max_num ?? 3, 'route' => route('admin.country.reorder.save')] )
@endpush
