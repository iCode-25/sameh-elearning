...
@section('title', \App\Helpers\TranslationHelper::translate('Roles'))
            ...
            <div class="card-toolbar w-100 mb-7">
                ...
                <div class="d-flex justify-content-between w-100 data-kt-Customer-table-toolbar">
                    <div class="left-part">
                        <!--begin::Add Service-->
                        {{-- @can('roles.create') --}}
                        @if (auth()->guard('admin')->user()->can('roles.create', 'admin'))
                        <a href="{{ route('admin.role.create') }}" class="btn btn-primary text-gray-800">
                            <i class="ki-duotone ki-plus fs-2  text-gray-800"></i>
                            {{\App\Helpers\TranslationHelper::translate('Create Role')}}
                        </a>
                        @endif
                        {{-- @endcan --}}
