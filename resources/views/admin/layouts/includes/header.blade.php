<div id="kt_app_header" class="app-header" data-kt-sticky="true"
    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
        ...
        <div class="d-flex align-items-center d-lg-none ms-n3 me-1 me-md-2" title="Show sidebar menu">
           ...
           {{-- <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="{{ route('admin.index') }}" class="d-lg-none">
                <img alt="Logo" src="{{ setting('logo', 'en') }}" class="h-30px"
                     style="background: #246eb7;padding: 5px;border-radius: 10px;"/>
            </a>
        </div> --}}
        ...
        {{-- <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
    <a href="{{ route('admin.index') }}" class="d-lg-none">
        <img alt="Logo" src="{{ asset('dashboard/assets/media/logos/logo.png') }}" class="h-30px"
             style="background: #246eb7;padding: 5px;border-radius: 10px;"/>
    </a>
</div> --}}
    ...
    <img alt="Logo" src="{{ asset('dashboard/assets/media/logos/logo.png') }}"
         class="h-25px app-sidebar-logo-default"
         style="max-height: 25px; width: auto; max-width: 150px;" />
    <img alt="Logo" src="{{ asset('dashboard/assets/media/logos/logo.png') }}"
         class="h-20px app-sidebar-logo-minimize"
         style="max-height: 20px; width: auto; max-width: 120px;" />
</a> --}}
...
{{--                <div class="py-6 mx-4 fs-6 ">--}}
{{--                    <a href="{{route('admin.loginToLandingDashboard')}}" class="btn btn-primary text-center btn-sm fw-bold" target="_blank">--}}
{{--                        {{\App\Helpers\TranslationHelper::translate('Landing Dashboard')}}--}}
{{--                    </a>--}}
{{--                </div>--}}
                <!--end::Search-->
...
{{--                            @if(app()->getLocale() == $key)--}}
                               {{-- <img src="{{asset('dashboard/assets/img/'.$key.'.png')}}" class="rounded-3 custom_img" alt="user"/> --}}
{{--                            @endif--}}{{--                        @endforeach--}}
{{--                    </div>--}}
...
{{--                                <a class="menu-link px-5" rel="alternate"--}}
{{--                                   hreflang="{{ $key }}"--}}
{{--                                   href="{{ LaravelLocalization::getLocalizedURL($key, null, [], true) }}">--}}
{{--                                    <img src="{{asset('dashboard/assets/img/'.$key.'.png')}}" class="custom_img me-3" style="width: 30px" alt="user"/>--}}
...
{{--                    </div>--}}
                   ...
                   <div class="tr-header-right-lang d-none d-md-block me-3 mt-4 ps-3">
                            <select class="tr-select-lang form-select text-white" style="background-color: #666060;" onchange="location.href=this.value">
                                <option value="{{ LaravelLocalization::getLocalizedURL('ar') }}" @if(app()->getLocale() == 'ar') selected @endif>AR</option>
                                <option value="{{ LaravelLocalization::getLocalizedURL('en') }}" @if(app()->getLocale() == 'en') selected @endif>EN</option>
                            </select>
                        </div>
                            ...
                            <div class="tab-pane fade" id="kt_topbar_notifications_1" role="tabpanel">
                                ...
                                <div class="py-3 text-center border-top">
                                    <a href="pages/user-profile/activity.html"
                                       class="btn btn-color-gray-600 btn-active-color-primary">{{ \App\Helpers\TranslationHelper::translate('View More') }}
                                ...
                                <div class="d-flex flex-column px-9">
                                    ...
                                    <div class="text-center px-4">
                                        <img class="mw-100 mh-200px" alt="image"
                                             src="{{asset('dashboard/assets/media/illustrations/sketchy-1/1.png')}}"/>
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                                <!--end::Wrapper-->
                                ...
                                <div class="scroll-y mh-325px my-5 px-8">
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                               class="text-gray-800 text-hover-primary fw-semibold">{{ \App\Helpers\TranslationHelper::translate('Server OS update') }}
                                                </a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <!--end::Section-->
                                        <!--begin::Label-->
                                        <span class="badge badge-light fs-8"> {{ \App\Helpers\TranslationHelper::translate('Jun') }}30</span>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            <!--begin::Code-->
                                            <span class="w-70px badge badge-light-danger me-4">500{{ \App\Helpers\TranslationHelper::translate('ERR') }}
															</span>
                                            <!--end::Code-->
                                            <!--begin::Title-->
                                            <a href="#"
                                               class="text-gray-800 text-hover-primary fw-semibold">Refund{{ \App\Helpers\TranslationHelper::translate('Pro') }}
                                                process</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                        <!--begin::Label-->
                                        <span class="badge badge-light fs-8">{{ \App\Helpers\TranslationHelper::translate('Jul') }} 10</span>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            <!--begin::Code-->
                                            <span class="w-70px badge badge-light-danger me-4">500
															{{ \App\Helpers\TranslationHelper::translate('ERR') }}</span>
                                            <!--end::Code-->
                                            <!--begin::Title-->
                                            <a href="#"
                                               class="text-gray-800 text-hover-primary fw-semibold">{{ \App\Helpers\TranslationHelper::translate('Withdrawal process ') }}
                                                </a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                        <!--begin::Label-->
                                        <span class="badge badge-light fs-8">{{ \App\Helpers\TranslationHelper::translate('Sep') }} 10</span>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                               class="text-gray-800 text-hover-primary fw-semibold">Mail{{ \App\Helpers\TranslationHelper::translate('Pro') }}
                                                {{ \App\Helpers\TranslationHelper::translate('tasks') }}</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                        <!--begin::Label-->
                                        <span class="badge badge-light fs-8">{{ \App\Helpers\TranslationHelper::translate('Dec') }} 10</span>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Item-->
                                </div>
                    ...
                    <div
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <!--begin::Username-->
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5">{{ \App\Helpers\TranslationHelper::translate('Admin') }}
                                        <span
                                            class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{{ \App\Helpers\TranslationHelper::translate('Pro') }}</span>
                                    </div>
                                    <a href="#"
                        ...
                        {{-- <div class="menu-item px-5">
                            <a href="#" class="menu-link px-5">{{ \App\Helpers\TranslationHelper::translate('My Profile') }}</a>
                        </div>
                  
                        <div class="menu-item px-5">
                            <a href="#" class="menu-link px-5">{{ \App\Helpers\TranslationHelper::translate('Account info') }}</a>
                        </div>
   
                        <div class="menu-item px-5 my-1">
                            <a href="#" class="menu-link px-5">{{ \App\Helpers\TranslationHelper::translate('Account Settings') }}</a>
                        </div> --}}
                        ...
                        <div class="menu-item px-5">
                            <a class="menu-link px-5" href="{{ route('logout') }}" onclick="event.preventDefault();
                                ...
                                {{\App\Helpers\TranslationHelper::translate('Sign Out')}}
                            </a>
...
{{--                    --}}{{--                                           class="lang-site"> {{ $lang }} </a>--}}
{{--                    <a class="lang-site " rel="alternate"--}}
{{--                       hreflang="{{ $key }}"--}}
{{--                       href="{{ LaravelLocalization::getLocalizedURL($key, null, [], true) }}">--}}
{{--                        {{ $lang }} </a>--}}
...
{{--            --}}
{{--            <a href="javascript:void(0)" class="dropdown-toggle lang-site"--}}
{{--               data-bs-toggle="dropdown">--}}
{{--                <img src="test" alt="flag"--}}
{{--                     style="width: 30px;border-radius: 2px;">--}}
{{--                <span style="vertical-align: top;">name</span>--}}
{{--            </a>--}}
{{--            <ul class="dropdown-menu fade-down drop_width_fix">--}}
{{--                @foreach (config('language') as $key => $lang)--}}
{{--                    <li>--}}
{{--                        <a class="lang-site dropdown-item" rel="alternate"--}}
{{--                           hreflang="{{ $key }}"--}}
{{--                           href="{{ LaravelLocalization::getLocalizedURL($key, null, [], true) }}">--}}
{{--                            {{ $lang }} </a>--}}
{{--                    </li>--}}
