                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-sm-6">
                                <div class="title-content">
                                    <h1 class="dark-gray fw-700">
                                        {{ \App\Helpers\TranslationHelper::translate('Blog Detail') }}
                                    </h1>
                                </div>
                                <div class="img-block">
                            ...
                            <div class="col-lg-6 col-sm-6 d-sm-block d-none">
                                <div class="title-image">
                                    <img src="{{ setting('image_banner_page_blog_web', 'en') }}"
                                        alt="">
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                        ...
                        <div class="category-block box-2 mb-24">
                            <div class="title" data-count="2">
                                <h5 class="fw-800 dark-gray mb-16">
                                    {{ \App\Helpers\TranslationHelper::translate('Latest Blogs') }}</h5>
                            </div>
                            <div class="hr-line mb-16"></div>
                            <div class="content-block mt-24">
                                @foreach ($blogs as $item)
                                    <a href="{{ route('site.blog-details', $item->id) }}"
                                        class="recent-blogs d-flex gap-12 align-items-center mb-24">
                                        <div class="image-box d-flex flex-shrink-0 br-4">
                                            <img src="{{ $item->getFirstMediaUrl('blogs_image') }}" alt=""
                                                class="br-4" width="89px" height="89px">
                                        </div>
                                        <div>
                                            <p class="text fw-500 mb-8">{{ Str::limit($item->name, 50) }}</p>
                                            <p class="dark-gray fw-400">{{ $item->created_at->format('d m y') }}</p>
                                        </div>
                                    </a>
                                @endforeach
                            </div>
                ...
                <div class="col-xl-9">
                    <div class="detail-image mb-24">
                        <img src="{{ $blog->getFirstMediaUrl('blogs_image') }}" alt="image">
                    </div>
                    <div class="d-flex gap-12 align-items-center mb-24">
                        ...
                        <p class="eye-brow-2 light-gray fw-400">{{ $blog->created_at->format('d M Y') }}</p>
                        <p class="fw-700 light-gray">
                            {{ \App\Helpers\TranslationHelper::translate('Mr') . ' ' . \App\Helpers\TranslationHelper::translate('AbdulHamid') }}
                        </p>
                    </div>
                    <h4 class="dark-gray fw-800 mb-24">{{ $blog->name }}</h4>
                    <div class="light-gray mb-32">{!! $blog->description !!}</div>
