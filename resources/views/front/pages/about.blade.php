                ...
                <div class="col-xl-10">
                    <div class="row">
                        ...
                        <div class="col-xl-7">
                            ...
                            <h2 class="dark-gray fw-800 mb-16"> {{ setting('title_about_us', app()->getLocale()) }}
                                {{-- {{ \App\Helpers\TranslationHelper::translate('And') }} <span class="color-primary">{{ \App\Helpers\TranslationHelper::translate('Whenever') }}</span> --}}
                            </h2>

                            <p class="light-gray mb-32">
                                {!! setting('description_about_us', app()->getLocale()) !!}
                            </p>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="img-service">
                    <img src="{{ asset('front/assets/media/user/bulb.png') }}" alt="bulb">
                </div>
                <div class="col-xl-10 ">
                    <div class="row align-items-center">
                        <div class="col-xl-5">
                            <div class="eyebrow">{{ \App\Helpers\TranslationHelper::translate('Services') }}</div>
                            <h2 class="dark-gray fw-800 mb-16">
                                {{ \App\Helpers\TranslationHelper::translate('From Confusion to Excellence') }}
                                <span class="color-sec ">
                                    {{ \App\Helpers\TranslationHelper::translate('Your Excellence in Chemistry') }}</span>
                            </h2>

                            <a href="{{ route('site.lessons') }}" class="cus-btn-3">
                                <span class="btn-text">{{ \App\Helpers\TranslationHelper::translate('Lessons') }}</span>
                                <span>{{ \App\Helpers\TranslationHelper::translate('Lessons') }}</span>
                            </a>
                        </div>
...
<style>
    ...
    <p class="light-gray heading fw-400 mb-48">
        <a href="{{ route('site.blogs') }}">
            <span class="color-primary fw-700">{{ \App\Helpers\TranslationHelper::translate('Explore all Blogs') }}<svg
