...
@section('content')
    ...
    <section class="contact py-80">
        <div class="container-fluid">
            <h2 class="medium-black fw-700 heading mb-16">{{ $contact->title }}?
                ...
                <div class="row row-gap-4 justify-content-between">
                        ...
                        <div class="d-flex gap-16 align-items-center">
                            ...
                            <div>
                                {{-- <h6 class="dark-gray fw-600 mb-6">
                                    {{ \App\Helpers\TranslationHelper::translate('Contact Us') }}</h6> --}}
                                <p class="fw-400 mb-6 light-gray">
                                    {{ \App\Helpers\TranslationHelper::translate('Call us') }}: <span
                                        class="color-primary fw-700"><a
                                            href="tel:+12345678">{{ $contact->phone }}</a></span></p>

                                <p class="light-gray">
                                    {{ \App\Helpers\TranslationHelper::translate('Email') }}:&nbsp;{{ $contact->email }}</p>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="d-flex gap-16 align-items-center">
                            ...
                            <div>
                                <h6 class="dark-gray fw-600 mb-6">
                                    {{ \App\Helpers\TranslationHelper::translate('whatsapp') }}</h6>
                                <span class="color-primary fw-700">
                                    <a href="tel:{{ $contact->whatsapp }}">{{ $contact->whatsapp }}
                                    </a>
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="d-flex gap-16 align-items-center">
                            ...
                            <div>
                                <h6 class="dark-gray fw-600 mb-6">
                                    {{ \App\Helpers\TranslationHelper::translate('Our Location') }}</h6>
                                <p class="fw-400 mb-6 light-gray">{{ $contact->address }}</p>
            ...
            <div class="row row-gap-4">
                <div class="col-xl-6">
                    <div class="img-contact">
                        <img src="{{ $contact->getFirstMediaUrl('contacts_meta_image') }}" alt="contct">
                    </div>
                </div>
                <div class="col-xl-6">
                    <!-- Alert Message -->
                    ...
                    <div class="contact-block">
                        <h4 class="mb-2"> {{ \App\Helpers\TranslationHelper::translate('Contact Us Now') }}</h4>
                        <form method="post" class="contact-form" id="contactForm" action="{{ route('create_message') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <button type="submit" class="cus-btn-3">
                                        <span>{{ \App\Helpers\TranslationHelper::translate('submit') }}</span>
                                        <span>{{ \App\Helpers\TranslationHelper::translate('submit') }}</span>
