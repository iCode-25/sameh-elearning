                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-sm-6">
                                <div class="title-content">
                                    ...
                                    <h5 class="light-gray fw-700">
                                        {{ $package->level?->getTranslation('name', app()->getLocale()) }}</h5>
                                </div>
                                <div class="img-block">
        ...
        <div class="container-fluid">
            <div class="row row-gap-4">
                <div class="col-xxl-12">
                    ...
                    <div class="light-gray mb-5">{!! $package->getTranslation('description', app()->getLocale()) !!}</div>
