...
<head>
    ...
    <title>{{ \App\Helpers\TranslationHelper::translate('privacy policy') }}</title>
    <style>
        body {
...
@else
    <p>{{ \App\Helpers\TranslationHelper::translate('No privacy policy and conditions available at the moment.') }}</p>
@endif
          </p>
          </div> 
