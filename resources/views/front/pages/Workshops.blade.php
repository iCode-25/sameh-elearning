                ...
                <div class="col-md-8">
                        ...
                        <section class="hero-main-jop-tow">
                            <div class="titel-viaous-main">
                                <div class="main-img-owrks">
                                    <div class="title-jop">
                                        {{ \App\Helpers\TranslationHelper::translate('categories') }}
                                        <br>{{ \App\Helpers\TranslationHelper::translate('workshops') }}
                                    </div>
                                </div>
                            </div>
                        </section>
                    ...
                    <section class="hero-main-jop-2" data-aos="fade-up" data-aos-delay="100">
                        <div class="titel-hero-main">
                            {{ \App\Helpers\TranslationHelper::translate('About workshops') }}
                        </div>
                        <div class="container">
                            <div class="lliest-evint-workshop">
                                <p class="feature-text">
                                    {!! setting('about_workshops', app()->getLocale()) !!}
                                </p>
                            </div>
                        </div>
                    </section>
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    @foreach ($categories as $category)
                                        <div class="swiper-slide">
                                            <div style="text-align: center; font-weight: bold;" class="main-stor-tow2"
                                                data-aos="zoom-in" data-aos-delay="100">
                                                <a href="{{ route('details-workshops-by-category', ['id' => $category->id]) }}"
                                                    class="custom-button">
                                                    <img class="ad-image"
                                                        src="{{ $category->getFirstMediaUrl('categories') }}"
                                                        alt="{{ $category->name }}">
                                                </a>
                                                <h3 style="margin-top: 8px;">{{ $category->name }}</h3>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
