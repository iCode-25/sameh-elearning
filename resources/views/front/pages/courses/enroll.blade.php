...
@section('content')
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-sm-6">
                                <div class="title-content">
                                    <h1 class="dark-gray mb-5 fw-700">
                                        {{ \App\Helpers\TranslationHelper::translate('payment lesson') }}</h1>
                                    <h5 class="light-gray fw-700">{{ $lesson->getTranslation('name', app()->getLocale()) }}
                                        </h1>
                                </div>
                                <div class="img-block">
                            ...
                            <div class="col-lg-6 col-sm-6 d-sm-block d-none">
                                <div class="title-image">
                                    <img src="{{ $lesson->getFirstMediaUrl('newsimage_newsimage_news') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="billing-detail py-80">
        <div class="container-fluid">
            <div class="row row-gap-4">
                <div class="col-xxl-12">
                    <div class="billing-wrapper mb-40">
                        <div class="title-row title-row-2 mb-24">
                            <h5 class="fw-500 black">{{ \App\Helpers\TranslationHelper::translate('Billing Details') }}</h5>
                        </div>
                        <form action="checkout.html" method="post" class="contact-form mb-16">
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        <!-- Payment Method -->
                        <div class="title-row title-row-2 mb-24">
                            <h5 class="fw-500 black">Payments Methods</h5>
                        </div>
                        <div class="shipping-radio-container">
                            <form action="tracking.html" method="post" class="mb-32">
                                <div class="plans mb-16">
                                    <label class="plan basic-plan" for="credit">
                                        ...
                                        <span class="plan-content content-2">
                                            <img src="{{ asset('front/assets/media/icons/payment-card-1.png') }}"
                                                alt="">
                                    ...
                                    <label class="plan basic-plan" for="paypal">
                                        ...
                                        <span class="plan-content content-2">
                                            <img src="{{ asset('front/assets/media/icons/payment-card-2.png') }}"
                                                alt="">
                                            <span class="plan-details">
                                ...
                                <div class="plans mb-40">
                                    <label class="plan basic-plan" for="bank">
                                        ...
                                        <span class="plan-content content-2">
                                            <img src="{{ asset('front/assets/media/icons/payment-card-3.png') }}"
                                                alt="">
                                            <span class="plan-details">
                                    ...
                                    <label class="plan basic-plan" for="cod">
                                        ...
                                        <span class="plan-content content-2">
                                            <img src="{{ asset('front/assets/media/icons/payment-card-4.png') }}"
                                                alt="">
                                            <span class="plan-details">
                                                <span class="fw-500 black">Cash on Delivery</span>
                                            </span>
                                        </span>
                                    </label>
                                </div>
                            ...
                            <h5 class="fw-500 black mb-24">Payments Details</h5>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-block mb-16">
                                ...
                                <div class="col-md-6">
                                    <div class="input-block mb-16">
                                        <input type="text" name="date" id="checkIn"
                                            class="form-control sel-input date_to" placeholder="Select Date">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20"
                                            viewBox="0 0 21 20" fill="none">
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex align-items-center gap-8">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21"
                                            ...
                                            <path
                                                d="M18.0132 3.73975C17.0084 3.39459 16.2035 2.58511 15.8598 1.57437C15.6413 0.931671 15.0397 0.5 14.3625 0.5L5.63751 0.5C4.96048 0.5 4.35867 0.931671 4.14017 1.57437C3.79654 2.58511 2.99164 3.39459 1.98685 3.73975C1.3475 3.95947 0.917969 4.56296 0.917969 5.24152L0.917969 7.4487C0.917969 10.3289 1.78101 13.1022 3.41385 15.4689C4.90784 17.6342 6.96655 19.3287 9.36768 20.3694C9.56863 20.4565 9.78424 20.5 10 20.5C10.2156 20.5 10.4312 20.4565 10.6322 20.3694C13.0333 19.3289 15.092 17.6342 16.586 15.4689C18.2188 13.1022 19.082 10.3288 19.082 7.4487V5.24152C19.082 4.56296 18.6525 3.95947 18.0132 3.73975ZM17.9102 7.4487C17.9102 10.09 17.1187 12.6332 15.6213 14.8034C14.2522 16.788 12.3657 18.3409 10.1662 19.2941C10.0607 19.3399 9.93942 19.34 9.83368 19.2941C7.63397 18.3409 5.74768 16.788 4.37851 14.8034C2.88132 12.6333 2.08984 10.0901 2.08984 7.4487L2.08984 5.24152C2.08984 5.06329 2.20154 4.90521 2.36771 4.84814C3.71277 4.38596 4.79019 3.30319 5.24963 1.95157C5.30655 1.78433 5.46234 1.67188 5.63751 1.67188L14.3625 1.67188C14.5375 1.67188 14.6935 1.78433 14.7504 1.95157C15.2098 3.30319 16.2872 4.38596 17.6323 4.84814C17.7985 4.90521 17.9102 5.06329 17.9102 5.24152V7.4487Z"
                                                fill="#92949F" />
                                            <path
                                                d="M12.4898 8.09705H12.45V6.42834C12.45 5.07748 11.3509 3.97839 10 3.97839C8.64914 3.97839 7.55005 5.07748 7.55005 6.42834V8.09705H7.51022C6.73218 8.09705 6.09924 8.73013 6.09924 9.50818V12.8804C6.09924 14.3293 7.27814 15.5084 8.72696 15.5084H11.273C12.722 15.5084 13.9008 14.3293 13.9008 12.8804V9.50818C13.9008 8.73013 13.2678 8.09705 12.4898 8.09705ZM8.72192 6.42834C8.72192 5.72369 9.29535 5.15027 10 5.15027C10.7047 5.15027 11.2781 5.72369 11.2781 6.42834V8.0972H8.72192V6.42834ZM12.7289 12.8804C12.7289 13.6833 12.0758 14.3364 11.273 14.3364H8.72696C7.92419 14.3364 7.27112 13.6833 7.27112 12.8804V9.50818C7.27112 9.37634 7.37839 9.26907 7.51022 9.26907H12.4898C12.6216 9.26907 12.7289 9.37634 12.7289 9.50818V12.8804Z"
                                                fill="#92949F" />
                                            <path
                                                d="M10 10.6633C9.67636 10.6633 9.41406 10.9256 9.41406 11.2492V12.3562C9.41406 12.6799 9.67636 12.9422 10 12.9422C10.3236 12.9422 10.5859 12.6799 10.5859 12.3562V11.2492C10.5859 10.9256 10.3236 10.6633 10 10.6633Z"
                                                fill="#92949F" />
