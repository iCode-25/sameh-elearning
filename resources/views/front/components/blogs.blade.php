@if ($blogs->count() > 0)
    <section class="article-section py-80">
        <div class="eyebrow heading">{{ \App\Helpers\TranslationHelper::translate('blogs') }}</div>
        <h2 class="dark-gray fw-800 heading mb-48">
            {{ \App\Helpers\TranslationHelper::translate('Insights and') }}&nbsp;
            <span class="color-sec">
                {{ \App\Helpers\TranslationHelper::translate('blogs') }}
            </span>
        </h2>
                            ...
                            <div class="cursor-pointer col-xl-4 col-lg-4 col-md-6 col-sm-12">
                                <div data-url="{{ route('site.blog-details', $blog->id) }}"
                                    ...
                                    <div class="article-content d-flex flex-column flex-grow-1">
                                        ...
                                        <h6 class="fw-800 mb-16 line-clamp">{{ Str::limit(strip_tags($blog->name)) }}</h6>
