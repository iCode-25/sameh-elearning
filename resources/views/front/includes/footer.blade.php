<footer>
    <div class="container-fluid">
        <div class="footer-wrapper pb-40">
            <div class="col-xl-4">
                <div class="logo-block">
                    <img src="{{ setting('image_logo_web', 'en') }}" alt="" class="ft-logo mb-12">
                    <h6 class="dark-gray fw-800 mb-16">{{ \App\Helpers\TranslationHelper::translate('Follow Us!') }}</h6>
                    <div class="links-container">
                        {{-- Facebook --}}
                        <a href="{{ App\Models\Contact::first()->facebook }}" target="_blank" class="links">
                        ...
                        {{-- instagram --}}
                        <a href="{{ App\Models\Contact::first()->iniesta }}" target="_blank" class="links">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none">
                                <path
                        ...
                        {{-- Youtube --}}
                        <a href="{{ App\Models\Contact::first()->youtube }}" target="_blank" class="links">
                        ...
                        {{-- tiktok --}}
                        <a href="{{ App\Models\Contact::first()->tiktok }}" target="_blank" class="links">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white"
                        ...
                        {{-- Whatsapp --}}
                        <a href="https://wa.me/{{ App\Models\Contact::first()->whatsapp }}" target="_blank"
                            class="links">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white"
                        ...
                        {{-- X --}}
                        <a href="{{ App\Models\Contact::first()->x }}" target="_blank" class="links">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none">
                                <path
            ...
            <div class="col-xl-2">
                <div class="link-block quick-links">
                    <h6 class="dark-gray fw-800 mb-24">{{ \App\Helpers\TranslationHelper::translate('Quick Links') }}
                    </h6>
                    <ul class="footer-list list-unstyled">
                        <li class="mb-12 light-gray fw-400">
                            <a
                                href="{{ route('site.home') }}">{{ \App\Helpers\TranslationHelper::translate('Home Page') }}</a>
                        </li>
                        <li class="mb-12 light-gray fw-400">
                            <a
                                href="{{ route('site.about') }}">{{ \App\Helpers\TranslationHelper::translate('About Us') }}</a>
                        </li>
                        <li class="mb-12 light-gray fw-400">
                            <a
                                href="{{ route('site.lessons') }}">{{ \App\Helpers\TranslationHelper::translate('Lessons') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-xl-2">
                <div class="link-block quick-links">
                    ...
                    <ul class="footer-list list-unstyled">
                        <li class="mb-12 light-gray fw-400">
                            <a
                                href="{{ route('user.login.form') }}">{{ \App\Helpers\TranslationHelper::translate('Signup') }}</a>
                        </li>
                        <li class="mb-12 light-gray fw-400">
                            <a
                                href="{{ route('user.login.form') }}">{{ \App\Helpers\TranslationHelper::translate('Login') }}</a>
                        </li>
                        <li class="light-gray fw-400">
                            <a
                                href="{{ route('site.contact') }}">{{ \App\Helpers\TranslationHelper::translate('Contact') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-xl-3">
                <div class="link-block contact-block">
                    <h6 class="dark-gray fw-800 mb-24">{{ \App\Helpers\TranslationHelper::translate('Contact Us') }}
                    </h6>
                    <ul class="footer-list list-unstyled mb-32">
                        <li class="mb-16 d-flex align-items-center gap-12">
                            <a href="tel:123456987" class="d-flex align-items-center gap-12">
                                ...
                                {{ \App\Models\Contact::first()->phone }}
                            </a>
                        </li>
                        <li class="mb-32">
        ...
        <p class="bottom-bar light text-center">
            @2025
            {{ \App\Helpers\TranslationHelper::translate('All Rights Copyright') }}
            <a href="https://icode.hudurly.com/index" target="_blank" class="fw-700 color-sec"
                style="text-decoration: none;">
                iCode.
            </a>
            {{ \App\Helpers\TranslationHelper::translate('Design & Developed By') }}
