...
{{-- <script src="{{ asset('front/assets/js/vendor/video.js') }}"></script> --}}
...
<script>
    ...
    const name = {!! json_encode(auth('web')->user()->name ?? 'Guest') !!};
    const level = {!! json_encode(auth('web')->user()->level?->name ?? '') !!};
