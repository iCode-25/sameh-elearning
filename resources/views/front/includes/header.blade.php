            ...
            <div class="menu-button-right">
                <div class="main-menu__nav">
                    <ul class="main-menu__list d-flex gap-4">
                        <li><a href="{{ route('site.home') }}" class="nav-link {{ request()->routeIs('site.home') ? 'active' : '' }}">{{ \App\Helpers\TranslationHelper::translate('home') }}</a></li>
                        <li><a href="{{ route('site.about') }}" class="nav-link {{ request()->routeIs('site.about') ? 'active' : '' }}">{{ \App\Helpers\TranslationHelper::translate('ABOUT US') }}</a></li>
                        <li><a href="{{ route('site.blogs') }}" class="nav-link {{ request()->routeIs('site.blogs*') ? 'active' : '' }}">{{ \App\Helpers\TranslationHelper::translate('BLOG') }}</a></li>
                        <li><a href="{{ route('site.lessons') }}" class="nav-link {{ request()->routeIs('site.lessons*') ? 'active' : '' }}">{{ \App\Helpers\TranslationHelper::translate('Lessons') }}</a></li>
                        <li><a href="{{ route('site.packages') }}" class="nav-link {{ request()->routeIs('site.packages*') ? 'active' : '' }}">{{ \App\Helpers\TranslationHelper::translate('Packages') }}</a></li>
                        <li><a href="{{ route('site.contact') }}" class="nav-link {{ request()->routeIs('site.contact') ? 'active' : '' }}">{{ \App\Helpers\TranslationHelper::translate('CONTACT') }}</a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="lang-toggle-btn">
                    @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                        @if ($localeCode != app()->getLocale())
                            <a href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}" class="lang-circle">{{ strtoupper($localeCode) }}</a>
                        @endif
                    @endforeach
                </div>
