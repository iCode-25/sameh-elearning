                ...
                <div class="video-grid">
                    @foreach ($lessons as $lesson)
                        <div class="video-card">
                            <div class="card-img">
                                <img src="{{ $lesson->getFirstMediaUrl('newsimage_newsimage_news') }}" alt="video">
            ...
            <p class="light-gray heading fw-400 mt-4">
                <a href="{{ route('site.lessons') }}">
                    <span class="color-primary fw-700">
                        {{ \App\Helpers\TranslationHelper::translate('Explore all Lessons') }}
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 d-flex">
                            <div class="card border-0 shadow h-100 hover-shadow w-100">
                                <div class="card-head h-50 d-flex flex-column">
                                    <img src="{{ $lesson->getFirstMediaUrl('newsimage_newsimage_news') }}" alt="{{ $lesson->name }}"
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="mt-auto">
                                        <a href="{{ route('user.show_lesson', ['lesson' => $lesson->id]) }}"
                                            class="cus-btn">
                                            <span
