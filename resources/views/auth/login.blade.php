                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-sm-6">
                                <div class="title-content">
                                    <h1 class="dark-gray fw-700">{{ \App\Helpers\TranslationHelper::translate('register') }}
                                    </h1>
                                </div>
                                <div class="img-block">
                            ...
                            <div class="col-lg-6 col-sm-6 d-sm-block d-none">
                                <div class="title-image">
                                    <img src="{{ setting('image_banner_page_register_web', 'en') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row row-gap-4">
                <div class="col-xl-6">
                    <div class="account account-1 p-24">
                        ...
                        <p class="mb-32 light-gray">
                            {{ \App\Helpers\TranslationHelper::translate('Please Enter your detail to Sign In.') }}</p>
                                ...
                                <div class="col-sm-12">
                                    <div class="input-block mb-24">
                                        <input type="email" name="username" required class="form-control"
                                            placeholder="{{ \App\Helpers\TranslationHelper::translate('Username or email address') }}"
                                            value="{{ old('username') }}">
                ...
                <div class="col-xl-6">
                    <div class="account p-24">
                        ...
                        <p class="mb-32 light-gray">
                            {{ \App\Helpers\TranslationHelper::translate('Please Enter your detail to Sign Up.') }}</p>
                        <form action="{{ route('user.register.submit') }}" method="post" class="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="input-block mb-24">
                                        <input type="text" name="l_name" id="l_name" class="form-control" required
                                            placeholder="{{ \App\Helpers\TranslationHelper::translate('Last Name') }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            viewBox="0 0 20 20" fill="none">
                                            <path
                                                d="M10 0C7.09223 0 4.72656 2.36566 4.72656 5.27344C4.72656 8.18121 7.09223 10.5469 10 10.5469C12.9078 10.5469 15.2734 8.18121 15.2734 5.27344C15.2734 2.36566 12.9078 0 10 0ZM10 9.375C7.7384 9.375 5.89844 7.53504 5.89844 5.27344C5.89844 3.01184 7.7384 1.17188 10 1.17188C12.2616 1.17188 14.1016 3.01184 14.1016 5.27344C14.1016 7.53504 12.2616 9.375 10 9.375Z"
                                ...
                                <div class="col-sm-12">
                                    <div class="input-block mb-24">
                                        <input type="text" name="phone" required class="form-control"
                                            placeholder="{{ \App\Helpers\TranslationHelper::translate('phone') }}">
                                ...
                                <div class="col-sm-12">
                                    <div class="input-block mb-24">
                                        <input type="password" class="form-control password-input" id="password2"
                                            ...
                                            placeholder="{{ \App\Helpers\TranslationHelper::translate('password confirmation') }}"
                                            required>
                                        <i class="fas fa-eye-slash" id="eye-icon"></i>
                                    </div>
                                </div>
                                    ...
                                    <div class="input-block mb-24">
                                        <select name="gender" id="gender" class="form-control" required>
                                            <option value="" selected>
                                                {{ \App\Helpers\TranslationHelper::translate('select gender') }}</option>
                                            <option value="male">{{ \App\Helpers\TranslationHelper::translate('male') }}
                                            </option>
                                            <option value="female">
                                                {{ \App\Helpers\TranslationHelper::translate('female') }}</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="input-block mb-24">
                                        <select name="type" id="type" class="form-control" required>
                                            <option value="" selected>
                                                {{ \App\Helpers\TranslationHelper::translate('Select Type') }}</option>
                                            <option value="azhar">{{ \App\Helpers\TranslationHelper::translate('Azhar') }}</option>
                                            <option value="general">{{ \App\Helpers\TranslationHelper::translate('General') }}</option>
                                        </select>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                <div class="col-md-6">
                                    <div class="input-block mb-24">
                                        <select name="level_id" id="level" class="form-control" required>
                                            <option value="" selected>
                                                {{ \App\Helpers\TranslationHelper::translate('Select Level') }}</option>
                                ...
                                <div class="col-sm-12">
                                    <p class="mb-32">
                                        {{ \App\Helpers\TranslationHelper::translate('Your personal information helps improve your experience on our site, manage your account, and fulfill other purposes as detailed in our') }}
                                ...
                                <div class="col-sm-12">
                                    <button type="submit" class="cus-btn-3">
                                        <span>{{ \App\Helpers\TranslationHelper::translate('register') }}</span>
                                        <span>{{ \App\Helpers\TranslationHelper::translate('register') }}</span>
                                    </button>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="privacyModalLabel">
                        {{ \App\Helpers\TranslationHelper::translate('Terms and Conditions') }}</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>{!! \App\Models\Termsandcondition::first()->description !!}</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary"
                        data-bs-dismiss="modal">{{ \App\Helpers\TranslationHelper::translate('close') }}</button>
                </div>
            </div>
        </div>
    </div>
